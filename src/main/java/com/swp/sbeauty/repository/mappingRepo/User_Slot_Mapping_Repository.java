...
public interface User_Slot_Mapping_Repository extends JpaRepository<User_Slot_Mapping, Long> {
    ...
    User_Slot_Mapping getUser_Slot_MappingBySchedule(Long userId, Long slotId, String date);

    @Query(value = "select a from User_Slot_Mapping a where a.id_schedule = ?1")
    User_Slot_Mapping getUser_Slot_MappingById_schedule(Long id);
}
